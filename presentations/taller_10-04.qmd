...
::: {.columns}
::: {.column width="55%" style="font-size:30px;"}
...
::: {.columns}
::: {.column width="48%" style="font-size:30px;"}
**① Script / Editor**  
...
::: {.callout-tip style="font-size:25px"}
...
## Recodificar variables con `dplyr` {background-color="#f8f9fa"}
...
::: {.callout-note style="font-size:25px"}
...
## Recodificar con condiciones: `case_when()` {background-color="#f8f9fa"}
...
::: {.callout-tip style="font-size:30px"}
